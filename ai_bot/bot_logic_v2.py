...
def fix_kazakh_transliteration(text: str) -> str:
    ...
    kazakh_patterns = [
        r'\бмын\b', r'\бмін\b', r'\ббыз\b', r'\бміз\b',  # мои окончания
        r'\бсың\b', r'\бсің\b',  # твои окончания
        r'\бды\b', r'\бді\b', r'\бты\b', r'\бті\b',  # падежные окончания
        r'\бға\b', r'\бге\b', r'\бқа\b', r'\бке\b',  # направление
        r'\бдан\b', r'\бден\b', r'\бтан\b', r'\бтен\b',  # исходный падеж
        r'\бмен\b', r'\ббен\b', r'\бпен\b',  # совместный падеж
        r'\бнда\b', r'\бнде\b',  # местный падеж
        r'\блар\b', r'\блер\b', r'\бдар\b', r'\бдер\b', r'\бтар\b', r'\бтер\b',  # множественное число
        r'\бшы\b', r'\бші\b', r'\бшылар\b', r'\бшілер\b',  # профессии
        r'\блық\b', r'\блік\b', r'\бтық\b', r'\бтік\b',  # суффиксы
        r'\бсыз\b', r'\бсіз\b',  # без чего-то
        r'\бға\b', r'\бге\b', r'\бқа\b', r'\бке\b',
